<script setup>
// Rutas CORREGIDAS: Se cambió 'src/icons/archivo.svg' por '@/archivo.svg' 
// para resolver correctamente las imágenes ubicadas en la raíz de 'src/'.
import img1 from '../icons/js.svg';
import img2 from '../icons/python.svg';
import img4 from '../icons/Java.svg';
import img5 from '../icons/sql.svg';
import img6 from '../icons/react.svg';
import img7 from '../icons/vue.svg';
import img8 from '../icons/node.svg';
import img11 from '../icons/git.svg';
import img15 from '../icons/visual.svg';
import img17 from '../icons/mysql.svg';
import img19 from '../icons/arg.svg';
import img20 from '../icons/EEUU.svg';
...
const habilidades = ref([
    {// Se crea un objeto con id, nombre y habilidades
        id: 1, nombre: 'Lenguajes de Programación', habilidades: [
            ...
            { id: 3, nombre: 'Java', nivel: 'Intermedio', icono: img4 },
            { id: 4, nombre: 'SQL', nivel: 'Intermedio', icono: img5 }
        ]
    },
    {
    ...
    },
    {
        id: 3, nombre: 'Herramientas y Software', habilidades: [
            ...
            { id: 2, nombre: 'Visual Studio Code', nivel: 'Avanzado', icono: img15 }
        ]
    },
    {
        id: 4, nombre: 'Bases de Datos', habilidades: [
            { id: 1, nombre: 'MySQL', nivel: 'Intermedio', icono: img17 },
        ]
    },
    {
