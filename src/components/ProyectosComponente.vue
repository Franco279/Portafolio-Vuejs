...
// ✅ Uso de const e inicialización directa para mayor limpieza
const misProyectos = ref([
    //esto es un array de objetos que contiene información sobre los proyectos
    {
        id: 1,
        src: proyecto1,
        titulo: "Sistema de Gestión de Inventario para Pymes (Web App)",
        descripcion: "Plataforma web completa diseñada para pequeñas y medianas empresas para rastrear inventario, gestionar pedidos y generar reportes de ventas en tiempo real.",
    },
    {
        id: 2,
        src: proyecto2,
        titulo: "Desarrollo de Videojuegos / Interactivo Web",
        descripcion: "Un juego 2D basado en navegador que utiliza la lógica de puzles para enseñar conceptos básicos de JavaScript. El usuario debe escribir o arrastrar bloques de código para resolver desafíos en pantalla.",
    ...
    },
    {
        id: 3,
        src: proyecto3,
        titulo: "Desarrollo de Aplicaciones Móviles (Híbridas)",
        descripcion: "Aplicación móvil para encontrar y evaluar servicios (talleres, farmacias) en un radio de 5 km. Permite a los usuarios dejar reseñas y subir fotos.",
        projectoLink: "https://www.google.com.ar",
        githubLink: "https://github.com/usuario/proyecto"
    },
    {
        id: 4,
        src: proyecto4,
        titulo: "Diseño y Desarrollo Frontend (Portafolio Personal)",
        descripcion: "El portafolio que estás viendo. Enfocado en la optimización del rendimiento y una experiencia de usuario (UX) accesible y estética.",
        projectoLink: "https://www.google.com.ar",
        githubLink: "https://github.com/usuario/proyecto"
    },
]);
